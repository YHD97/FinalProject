...
LOAD_FROM = 'LeagueAIDQN/save-00000937'
...
if LOAD_FROM is None:
    ...
    player_list = [np.load("D:\FinalProject\DQNDATA\playerState.npy", allow_pickle=True)]
    print('Loaded')
...
try:
    with writer.as_default():
        while frame_number < TOTAL_FRAMES:
            ...
            np.save('D:\FinalProject\DQNDATA\episode_reward_history_10.npy', rewards, allow_pickle=True,
                    fix_imports=True)
            np.save('D:\FinalProject\DQNDATA\playerState.npy', player_list, allow_pickle=True, fix_imports=True)
            np.save('D:\FinalProject\DQNDATA\loss.npy', loss_list, allow_pickle=True, fix_imports=True)
